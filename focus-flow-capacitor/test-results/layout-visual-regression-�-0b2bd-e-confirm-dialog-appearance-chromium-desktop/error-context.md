...
- complementary:
  ...
  - text: ⋮⋮ 📝 削除テスト 📅 明日 ⏱️ 30分
  - checkbox "Mark \"削除テスト\" as complete"
  - button "Edit \"削除テスト\"": ✏️
  - button "Delete \"削除テスト\"": 🗑️
  - button "Start focus mode for \"削除テスト\"": 🎯
...
- dialog "Delete Task":
  - heading "Delete Task" [level=3]
  - paragraph: Are you sure you want to delete this task? This action cannot be undone.
  - button "Cancel"
  - button "Delete"
```