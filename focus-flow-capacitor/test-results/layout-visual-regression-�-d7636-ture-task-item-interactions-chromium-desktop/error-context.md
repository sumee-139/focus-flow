...
- complementary:
  ...
  - status "2025年7月29日(火)のタスク統計":
    - text: 7/29(火) 3件 完了1件 見積:3時間 0 達成率:33%
    - progressbar
  - text: ⋮⋮ 📝 インタラクションテスト 📅 明日 ⏱️ 30分
  - checkbox "Mark \"インタラクションテスト\" as complete"
  - button "Edit \"インタラクションテスト\"": ✏️
  - button "Delete \"インタラクションテスト\"": 🗑️
  - button "Start focus mode for \"インタラクションテスト\"": 🎯
